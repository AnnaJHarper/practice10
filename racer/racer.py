...
background = pygame.image.load(r"C:\Users\Mereilim\Desktop\repo\work\practice10\racer\159\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, h):
        self.h = h
        super().__init__()
        self.image = pygame.image.load("159/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("159/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.original_image = pygame.image.load("159/coin.png").convert_alpha()
